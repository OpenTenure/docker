...
INSERT INTO system.config_map_layer VALUES ('claims', 'Claims::::::::::::::::::::::::::::::::::::', 'wms', true, false, 12, '', 'http://localhost:8085/geoserver/opentenure/wms', 'opentenure:claims', '1.1.1', 'image/png', '', '', NULL, NULL, '', '', '', false, false, true);
INSERT INTO system.config_map_layer VALUES ('adminBoundaries', 'Administrative Boundaries::::::::::::::::::::::::::::::::::::', 'wms', true, false, 11, '', 'http://localhost:8085/geoserver/opentenure/wms', 'opentenure:boundaries', '1.1.1', 'image/png', '', '', NULL, NULL, '', '', '', false, false, true);
...
INSERT INTO system.setting VALUES ('moderation-days', '30', true, 'Duration of moderation time in days');
...
INSERT INTO system.setting VALUES ('email-msg-user-registration-subject', 'New user registration', true, 'Subject text for new user registration on OpenTenure Web-site. Sent to administrator.');
INSERT INTO system.setting VALUES ('email-msg-user-registration-body', 'New user "#{userName}" has been registered registered on SOLA OpenTenure Web-site.', true, 'Message text for new user registration on OpenTenure Web-site');
...
INSERT INTO system.setting VALUES ('email-msg-reg-subject', 'SOLA OpenTenure - registration', true, 'Subject text for new user registration on OpenTenure Web-site. Sent to user.');
INSERT INTO system.setting VALUES ('email-msg-pswd-restore-subject', 'SOLA OpenTenure - password restore', true, 'Password restore subject');
INSERT INTO system.setting VALUES ('email-msg-claim-submit-subject', 'SOLA OpenTenure - new claim submitted', true, 'New claim subject text');
...
INSERT INTO system.setting VALUES ('email-msg-claim-withdraw-subject', 'SOLA OpenTenure - claim withdrawal', true, 'Claim withdrawal notice subject');
...
INSERT INTO system.setting VALUES ('email-msg-claim-reject-subject', 'SOLA OpenTenure - claim rejection', true, 'Claim rejection notice subject');
...
INSERT INTO system.setting VALUES ('email-msg-claim-approve-review-subject', 'SOLA OpenTenure - claim review approval', true, 'Claim review approval notice subject');
...
INSERT INTO system.setting VALUES ('email-msg-claim-approve-moderation-subject', 'SOLA OpenTenure - claim moderation approval', true, 'Claim moderation approval notice subject');
INSERT INTO system.setting VALUES ('email-msg-claim-updated-body', 'Dear #{userFullName},<br /><br />Claim <b>##{claimNumber}</b> has been updated. Follow <a href="#{claimLink}">this link</a> to check claim status and updated information.<br /><br />Regards,<br />SOLA OpenTenure Team', true, 'Claim update body text');
...
INSERT INTO system.setting VALUES ('email-msg-claim-challenge-submitted-subject', 'SOLA OpenTenure - new claim challenge to the claim ##{claimNumber}', true, 'New claim challenge subject text');
INSERT INTO system.setting VALUES ('email-msg-claim-challenge-updated-subject', 'SOLA OpenTenure - claim challenge ##{challengeNumber} update', true, 'Claim challenge update subject text');
INSERT INTO system.setting VALUES ('email-msg-claim-updated-subject', 'SOLA OpenTenure - claim ##{claimNumber} update', true, 'Claim update subject text');
...
INSERT INTO system.setting VALUES ('email-msg-claim-challenge-approve-review-subject', 'SOLA OpenTenure - claim challenge review', true, 'Claim challenge review approval notice subject');
...
INSERT INTO system.setting VALUES ('email-msg-claim-challenge-approve-moderation-subj', 'SOLA OpenTenure - claim challenge moderation', true, 'Claim challenge moderation approval notice subject');
...
INSERT INTO system.setting VALUES ('email-msg-claim-challenge-reject-subject', 'SOLA OpenTenure - claim challenge rejection', true, 'Claim challenge rejection notice subject');
...
INSERT INTO system.setting VALUES ('email-msg-claim-challenge-withdraw-subject', 'SOLA OpenTenure - claim challenge withdrawal', true, 'Claim withdrawal notice subject');
...
INSERT INTO system.setting VALUES ('email-msg-notifiable-subject', 'SOLA REGISTRY - #{actionToNotify} action on property #{baUnitName}', true, 'Action on Interest subject text');
...
INSERT INTO system.setting VALUES ('email-msg-user-activation-subject', 'SOLA OpenTenure account activation', true, 'Subject text to notify Community member account activation on the Community Server Web-site');
INSERT INTO system.setting VALUES ('email-msg-reg-body', 'Dear #{userFullName},<p></p>You have registered on SOLA OpenTenure Web-site. Before you can use your account, it will be reviewed and approved by Community Technologist. 
...
INSERT INTO system.setting VALUES ('community-name', 'Open Community', true, 'Community name');
...
INSERT INTO system.setting VALUES ('docs_for_issuing_cert', 'signed_cert', true, 'List of document type codes, required to set certificate issued status');
...
INSERT INTO system.setting VALUES ('boundary-print-produced-by', 'Community Server of OpenTenure solution', true, 'Name of report producer. In real environment can be Ministry''s name.');
...
INSERT INTO system.setting VALUES ('claim_certificate_report_url', '/Reports/community_server/certificate/ClaimCertificate', true, '	URL to the claim certificate report, hosted on the reporting server');
...
INSERT INTO system.setting VALUES ('moderation_date', '2019-10-01', true, 'Closing date of public display for the claims. Date must be set in the format "yyyy-mm-dd". If date is not set or in the past, "moderation-days" setting will be used for calculating closing date.');
INSERT INTO system.setting VALUES ('system-id', 'sola-cs-docker-v1910', true, 'A unique number that identifies the installed SOLA system. This unique number is used in the br that generate unique identifiers.');
INSERT INTO system.setting VALUES ('ot-community-area', 'POLYGON((170.5165512337329 -45.8604302023619,170.52946875234488 -45.86035548577669,170.52865336080504 -45.868230061485164,170.51637957235656 -45.868005942873914,170.5165512337329 -45.8604302023619))', true, 'Open Tenure community area where parcels can be claimed');
INSERT INTO system.setting VALUES ('report_server_url', 'http://192.168.1.71:8090/jasperserver', true, 'Reporting server URL.');
INSERT INTO system.setting VALUES ('ot-title-plan-crs-wkt', 'GEOGCS["WGS 84",DATUM["WGS_1984",SPHEROID["WGS 84",6378137,298.257223563,AUTHORITY["EPSG","7030"]],AUTHORITY["EPSG","6326"]],PRIMEM["Greenwich",0,AUTHORITY["EPSG","8901"]],UNIT["degree",0.01745329251994328,AUTHORITY["EPSG","9122"]],AUTHORITY["EPSG","4326"]]', true, 'Custom Coordinate Reference System in WKT format of the map image, generated for claim certificate in OpenTenure');
INSERT INTO system.setting VALUES ('ot-title-plan-crs-proj4', '+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs', true, 'Custom Coordinate Reference System in Proj4 format, used for generating map image for claim certificate or boundary in OpenTenure. It should match to ot-title-plan-crs-wkt setting. If not provided, WGS84 will be used as default.');
INSERT INTO system.setting VALUES ('db-utilities-folder', '/usr/lib/postgresql/11/bin', true, 'Full path to PostgreSQL utilities (bin) folder (e.g. C:\Program Files\PostgreSQL\9.1\bin). Used for backup/restore implementation of SOLA Web admin application');
...
INSERT INTO version (version_num) VALUES ('1910a');
