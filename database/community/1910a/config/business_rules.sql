...
INSERT INTO system.br_definition VALUES ('generate-notation-reference-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymmdd'') || ''-'' || trim(to_char(nextval(''administrative.rrr_nr_seq''), ''0000'')) AS vl');
INSERT INTO system.br_definition VALUES ('generate-rrr-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymmdd'') || ''-'' || trim(to_char(nextval(''administrative.rrr_nr_seq''), ''0000'')) AS vl');
INSERT INTO system.br_definition VALUES ('generate-source-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymmdd'') || ''-'' || trim(to_char(nextval(''source.source_la_nr_seq''), ''000000000'')) AS vl');
INSERT INTO system.br_definition VALUES ('generate-baunit-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymm'') || trim(to_char(nextval(''administrative.ba_unit_first_name_part_seq''), ''0000''))
|| ''/'' || trim(to_char(nextval(''administrative.ba_unit_last_name_part_seq''), ''0000'')) AS vl');
INSERT INTO system.br_definition VALUES ('generate-cadastre-object-lastpart', '2014-02-20', 'infinity', 'SELECT cadastre.get_new_cadastre_object_identifier_last_part(#{geom}, #{cadastre_object_type}) AS vl');
INSERT INTO system.br_definition VALUES ('generate-cadastre-object-firstpart', '2014-02-20', 'infinity', 'SELECT cadastre.get_new_cadastre_object_identifier_first_part(#{last_part}, #{cadastre_object_type}) AS vl');
INSERT INTO system.br_definition VALUES ('generate-spatial-unit-group-name', '2014-02-20', 'infinity', 'SELECT cadastre.generate_spatial_unit_group_name(get_geometry_with_srid(#{geom_v}), #{hierarchy_level_v}, #{label_v}) AS vl');
INSERT INTO system.br_definition VALUES ('generate-application-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymm'') || trim(to_char(nextval(''application.application_nr_seq''), ''0000'')) AS vl');
INSERT INTO system.br_definition VALUES ('application-on-approve-check-public-display', '2014-02-20', 'infinity', '  SELECT (COUNT(*) = 0)  AS vl
...
INSERT INTO system.br_definition VALUES ('app-check-title-ref', '2014-02-20', 'infinity', 'WITH 	convertTitleApp	AS	(SELECT se.id FROM application.service se
...
SELECT CASE 	WHEN (SELECT (COUNT(*) = 0) FROM convertTitleApp) THEN NULL
		...
		ELSE FALSE
	END AS vl');
INSERT INTO system.br_definition VALUES ('application-br7-check-sources-have-documents', '2014-02-20', 'infinity', 'SELECT ext_archive_id IS NOT NULL AS vl
FROM source.source 
WHERE id IN (SELECT source_id FROM application.application_uses_source WHERE application_id= #{id})');
INSERT INTO system.br_definition VALUES ('app-allowable-primary-right-for-new-title', '2014-02-20', 'infinity', 'WITH 	newTitleApp	AS	(SELECT (SUM(1) > 0) AS fhCheck FROM application.service se
				WHERE se.application_id = #{id}
 ...
 SELECT CASE WHEN (SELECT ((SELECT * FROM newTitleApp) OR (SELECT * FROM existTitleApp)) IS NULL) THEN NULL 
	...
	END AS vl');
INSERT INTO system.br_definition VALUES ('app-other-app-with-caveat', '2014-02-20', 'infinity', 'SELECT (SELECT COUNT(*) > 0 FROM application.service sv WHERE sv.application_id = ap.application_id AND sv.request_type_code IN (''varyCaveat'', ''removeCaveat'')) AS vl
...
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition VALUES ('application-cancel-property-service-before-new-title', '2014-02-20', 'infinity', '
...
INSERT INTO system.br_definition VALUES ('app-title-has-primary-right', '2014-02-20', 'infinity', 'WITH 	newTitleApp	AS	(SELECT (SUM(1) > 0) AS fhCheck FROM application.service se
				WHERE se.application_id = #{id}
				AND se.request_type_code IN (''newFreehold'', ''newApartment'', ''newState'')),
...
INSERT INTO system.br_definition VALUES ('application-br2-check-title-documents-not-old', '2014-02-20', 'infinity', 'SELECT s.recordation + 1 * interval ''1 week'' > NOW() AS vl
...
INSERT INTO system.br_definition VALUES ('applicant-name-to-owner-name-check', '2014-02-20', 'infinity', 'WITH apStr AS (SELECT  COALESCE(name, '''') || '' '' || COALESCE(last_name, '''') AS searchStr FROM party.party pty
...
ORDER BY vl
LIMIT 1');
INSERT INTO system.br_definition VALUES ('application-br3-check-properties-are-not-historic', '2014-02-20', 'infinity', 'WITH baUnitRecs AS	(SELECT ba.status_code AS status FROM application.application_property ap
...
ORDER BY 1
LIMIT 1 ');
INSERT INTO system.br_definition VALUES ('application-br4-check-sources-date-not-in-the-future', '2014-02-20', 'infinity', 'SELECT ss.recordation < NOW() as vl FROM application.application_uses_source a_s
	INNER JOIN source.source ss ON (a_s.source_id = ss.id)
	WHERE a_s.application_id = #{id}
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition VALUES ('application-br6-check-new-title-service-is-needed', '2014-02-20', 'infinity', 'SELECT	CASE	WHEN (name_firstpart, name_lastpart) NOT IN (SELECT name_firstpart, name_lastpart FROM administrative.ba_unit)
...
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition VALUES ('application-on-approve-check-services-status', '2014-02-20', 'infinity', 'SELECT (COUNT(*) = 0)  AS vl FROM application.service sv 
WHERE sv.application_id = #{id} 
AND sv.status_code NOT IN (''completed'', ''cancelled'')');
INSERT INTO system.br_definition VALUES ('application-on-approve-check-services-without-transaction', '2014-02-20', 'infinity', 'SELECT (COUNT(*) = 0) AS vl FROM application.service sv 
	INNER JOIN transaction.transaction tn ON (sv.id = tn.from_service_id)
WHERE sv.application_id = #{id} 
AND sv.status_code NOT IN (''completed'', ''cancelled'')');
INSERT INTO system.br_definition VALUES ('application-on-approve-check-systematic-reg-no-objection', '2014-02-20', 'infinity', '  SELECT (COUNT(*) = 0)  AS vl
  ...
  and s.application_id = #{id};');
INSERT INTO system.br_definition VALUES ('application-br8-check-has-services', '2014-02-20', 'infinity', 'SELECT (COUNT(*) > 0) AS vl
FROM application.service sv 
WHERE sv.application_id = #{id}
AND sv.status_code != ''cancelled''');
INSERT INTO system.br_definition VALUES ('application-verifies-identification', '2014-02-20', 'infinity', 'SELECT (CASE 	WHEN app.id is  NULL THEN NULL
		ELSE COUNT(1) > 0
	 END) as vl
...
GROUP BY app.id
LIMIT 1');
INSERT INTO system.br_definition VALUES ('newtitle-br24-check-rrr-accounted', '2014-02-20', 'infinity', '
...
SELECT CASE WHEN fhCheck IS TRUE THEN (SELECT COUNT(nr) FROM rem_property_rrr) = 0
		ELSE NULL
	END AS vl FROM newFreeholdApp');
INSERT INTO system.br_definition VALUES ('application-br1-check-required-sources-are-present', '2014-02-20', 'infinity', 'WITH reqForAp AS 	(SELECT DISTINCT ON(r_s.source_type_code) r_s.source_type_code AS typeCode
...
SELECT 	CASE 	WHEN (SELECT (SUM(1) IS NULL) FROM reqForAp) THEN NULL
		...
		ELSE FALSE
	END AS vl');
INSERT INTO system.br_definition VALUES ('application-approve-cancel-old-titles', '2014-02-20', 'infinity', '
WITH 	newFreeholdApp	AS	(SELECT (SUM(1) > 0) AS fhCheck FROM application.service se
				WHERE se.application_id = #{id}
				AND se.request_type_code = ''newFreehold''),
...
SELECT CASE WHEN fhCheck IS TRUE THEN (SELECT COUNT(liveTitle) FROM parent_titles) > 0
	...
	END AS vl FROM newFreeholdApp
');
INSERT INTO system.br_definition VALUES ('application-br5-check-there-are-front-desk-services', '2014-02-20', 'infinity', 'SELECT CASE WHEN (COUNT(*)= 0) THEN NULL
	ELSE FALSE 
	end AS vl
...
INSERT INTO system.br_definition VALUES ('application-for-new-title-has-cancel-property-service', '2014-02-20', 'infinity', '
WITH 	newFreeholdApp	AS	(SELECT (SUM(1) > 0) AS fhCheck FROM application.service se
				WHERE se.application_id = #{id}
				AND se.request_type_code = ''newFreehold'')
...
SELECT CASE WHEN fhCheck IS TRUE THEN (SELECT COUNT(id) FROM application.service sv 
		...
		ELSE NULL
	END AS vl FROM newFreeholdApp');
INSERT INTO system.br_definition VALUES ('cancel-title-check-rrr-cancelled', '2014-02-20', 'infinity', 'WITH 	pending_property_rrr AS (SELECT DISTINCT ON(rr1.nr) rr1.nr FROM administrative.rrr rr1 
...
SELECT CASE 	WHEN (SELECT (COUNT(*) = 0) FROM cancelPropApp) THEN NULL
		...
		ELSE FALSE
	END AS vl');
INSERT INTO system.br_definition VALUES ('app-current-caveat-and-no-remove-or-vary', '2014-02-20', 'infinity', 'SELECT (SELECT (COUNT(*) > 0) FROM application.service sv 
...
ORDER BY 1 desc
LIMIT 1');
INSERT INTO system.br_definition VALUES ('documents-present', '2014-02-20', 'infinity', 'WITH cadastreDocs AS 	(SELECT DISTINCT ON (id) ss.id, ext_archive_id FROM source.source ss
...
INSERT INTO system.br_definition VALUES ('application-baunit-has-parcels', '2014-02-20', 'infinity', 'select (select count(*)>0 from administrative.ba_unit_contains_spatial_unit ba_su 
...
order by 1
limit 1');
INSERT INTO system.br_definition VALUES ('current-rrr-for-variation-or-cancellation-check', '2014-02-20', 'infinity', 'SELECT (SUM(1) > 0) AS vl FROM application.service sv 
...
LIMIT 1');
INSERT INTO system.br_definition VALUES ('power-of-attorney-owner-check', '2014-02-20', 'infinity', 'WITH poaQuery AS (SELECT person_name, py.name AS firstName, py.last_name AS lastName FROM transaction.transaction tn
...
ORDER BY vl
LIMIT 1');
INSERT INTO system.br_definition VALUES ('service-has-person-verification', '2014-02-20', 'infinity', 'SELECT (CASE 	WHEN sv.application_id is  NULL THEN NULL
		ELSE COUNT(1) > 0
	 END) as vl
FROM application.service sv
...
LIMIT 1');
INSERT INTO system.br_definition VALUES ('rrr-has-pending', '2014-02-20', 'infinity', 'select count(*) = 0 as vl
...
');
INSERT INTO system.br_definition VALUES ('ba_unit-has-a-valid-primary-right', '2014-02-20', 'infinity', 'SELECT (COUNT(*) = 1) AS vl FROM administrative.rrr rr1 
...
INSERT INTO system.br_definition VALUES ('application-baunit-check-area', '2014-02-20', 'infinity', 'select
       ( 
...
INSERT INTO system.br_definition VALUES ('baunit-has-multiple-mortgages', '2014-02-20', 'infinity', 'SELECT	(SELECT (COUNT(*) = 0) FROM application.service sv2
...
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition VALUES ('document-supporting-rrr-is-current', '2014-02-20', 'infinity', 'WITH serviceDocs AS	(SELECT DISTINCT ON (sc.id) sv.id AS sv_id, sc.id AS sc_id, sc.status_code, sc.type_code FROM application.service sv
				INNER JOIN transaction.transaction tn ON (sv.id = tn.from_service_id)
				INNER JOIN administrative.rrr rr ON (tn.id = rr.transaction_id)
				INNER JOIN administrative.source_describes_rrr sr ON (rr.id = sr.rrr_id)
...
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition VALUES ('mortgage-value-check', '2014-02-20', 'infinity', 'SELECT (ap.total_value < rrr.amount) AS vl 
...
order by 1
limit 1');
INSERT INTO system.br_definition VALUES ('power-of-attorney-service-has-document', '2014-02-20', 'infinity', 'SELECT (SUM(1) = 1) AS vl, get_translation(rt.display_value, #{lng}) as req_type FROM application.service sv
	 INNER JOIN transaction.transaction tn ON (sv.id = tn.from_service_id)
...
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition VALUES ('required-sources-are-present', '2014-02-20', 'infinity', 'WITH reqForSv AS 	(SELECT r_s.source_type_code AS typeCode
			FROM application.request_type_requires_source_type r_s 
				INNER JOIN application.service sv ON((r_s.request_type_code = sv.request_type_code) AND (sv.status_code != ''cancelled''))
			WHERE sv.id = #{id}),
...
ORDER BY vl
LIMIT 1');
INSERT INTO system.br_definition VALUES ('service-on-complete-without-transaction', '2014-02-20', 'infinity', 'select id in (select from_service_id from transaction.transaction where from_service_id is not null) as vl, 
...
and s.id= #{id}');
INSERT INTO system.br_definition VALUES ('service-title-terminated', '2014-02-20', 'infinity', 'WITH reqForSv AS 	(SELECT sv.id, get_translation(rt.display_value, #{lng}) AS req_type FROM application.service sv 
				INNER JOIN application.request_type rt ON (sv.request_type_code = rt.code)
			WHERE sv.id = #{id} 
...
ORDER BY vl
LIMIT 1');
INSERT INTO system.br_definition VALUES ('service-check-no-previous-digital-title-service', '2014-02-20', 'infinity', 'SELECT coalesce(not rrr.is_primary, true) as vl
FROM application.service s inner join application.application_property ap on s.application_id = ap.application_id
  INNER JOIN administrative.ba_unit ba ON (ap.name_firstpart, ap.name_lastpart) = (ba.name_firstpart, ba.name_lastpart)
  LEFT JOIN administrative.rrr ON rrr.ba_unit_id = ba.id
WHERE s.id = #{id} 
order by 1 desc
limit 1');
INSERT INTO system.br_definition VALUES ('target-ba_unit-check-if-pending', '2014-02-20', 'infinity', 'WITH	otherCancel AS	(SELECT (SELECT (COUNT(*) = 0)FROM administrative.ba_unit_target ba_t2 
...
INSERT INTO system.br_definition VALUES ('ba_unit-has-cadastre-object', '2014-02-20', 'infinity', 'SELECT count(*)>0 vl
from administrative.ba_unit_contains_spatial_unit ba_s 
WHERE ba_s.ba_unit_id = #{id}');
INSERT INTO system.br_definition VALUES ('ba_unit-has-compatible-cadastre-object', '2014-02-20', 'infinity', 'SELECT  co.type_code = ''parcel'' as vl
...
limit 1');
INSERT INTO system.br_definition VALUES ('ba_unit-spatial_unit-area-comparison', '2014-02-20', 'infinity', 'SELECT (abs(coalesce(ba_a.size,0.001) - 
...
WHERE ba.id = #{id}
');
INSERT INTO system.br_definition VALUES ('newtitle-br22-check-different-owners', '2014-02-20', 'infinity', 'WITH new_property_owner AS (
...
ORDER BY vl
LIMIT 1');
INSERT INTO system.br_definition VALUES ('cadastre-redefinition-target-geometries-dont-overlap', '2014-02-20', 'infinity', 'select coalesce(st_area(st_union(co.geom_polygon)) = sum(st_area(co.geom_polygon)), true) as vl
from cadastre.cadastre_object_target co where transaction_id = #{id}');
INSERT INTO system.br_definition VALUES ('area-check-percentage-newareas-oldareas', '2014-02-20', 'infinity', 'select abs((select cast(sum(a.size)as float)
	from cadastre.spatial_value_area a
	where a.type_code = ''officialArea''
        and a.spatial_unit_id in (
	   select co_new.id
   ...
   (select cast(sum(a.size)as float)
	...
	and a.spatial_unit_id in ( 
		...
		from cadastre.cadastre_object_target co_target
		    where co_target.transaction_id = #{id})) 
 < 0.001 as vl');
INSERT INTO system.br_definition VALUES ('area-check-percentage-newofficialarea-calculatednewarea', '2014-02-20', 'infinity', 'select count(*) = 0 as vl
...
INSERT INTO system.br_definition VALUES ('cadastre-object-check-name', '2014-02-20', 'infinity', 'Select cadastre.cadastre_object_name_is_valid(name_firstpart, name_lastpart) as vl 
FROM cadastre.cadastre_object
WHERE transaction_id = #{id} and type_code = ''parcel''
order by 1
limit 1');
INSERT INTO system.br_definition VALUES ('cadastre-redefinition-union-old-new-the-same', '2014-02-20', 'infinity', 'select st_equals(geom_to_snap,target_geom) as vl from cadastre.snap_geometry_to_geometry((select st_union(co.geom_polygon) from cadastre.cadastre_object co 
...
INSERT INTO system.br_definition VALUES ('new-cadastre-objects-do-not-overlap', '2014-02-20', 'infinity', 'WITH tolerance AS (SELECT CAST(ABS(LOG((CAST (vl AS NUMERIC)^2))) AS INT) AS area FROM system.setting where name = ''map-tolerance'' LIMIT 1)
...
INSERT INTO system.br_definition VALUES ('new-cadastre-objects-present', '2014-02-20', 'infinity', 'select count (*) > 0 as vl from cadastre.cadastre_object where transaction_id= #{id}');
INSERT INTO system.br_definition VALUES ('target-and-new-union-the-same', '2014-02-20', 'infinity', 'select st_equals(geom_to_snap,target_geom) as vl
...
where id in (select cadastre_object_id 
  ...
  system.get_setting(''map-tolerance'')::double precision, true)
 ');
INSERT INTO system.br_definition VALUES ('target-parcels-check-isapolygon', '2014-02-20', 'infinity', 'select St_GeometryType(ST_Union(co.geom_polygon)) = ''ST_Polygon'' as vl
 from cadastre.cadastre_object co 
  inner join cadastre.cadastre_object_target co_target
   on co.id = co_target.cadastre_object_id
    where co_target.transaction_id = #{id}');
INSERT INTO system.br_definition VALUES ('target-parcels-check-nopending', '2014-02-20', 'infinity', 'select (select count(*)=0 
...
where co_target.transaction_id = #{id}
 ');
INSERT INTO system.br_definition VALUES ('target-parcels-present', '2014-02-20', 'infinity', 'select count (*) > 0 as vl from cadastre.cadastre_object_target where transaction_id= #{id}');
INSERT INTO system.br_definition VALUES ('survey-points-present', '2014-02-20', 'infinity', 'select count (*) > 2  as vl from cadastre.survey_point where transaction_id= #{id}');
INSERT INTO system.br_definition VALUES ('ba_unit-has-several-mortgages-with-same-rank', '2014-02-20', 'infinity', 'WITH	simple	AS	(SELECT rr1.id, rr1.nr FROM administrative.rrr rr1
...
SELECT CASE 	WHEN	((SELECT rr5.id FROM administrative.rrr rr5 WHERE rr5.id = #{id} AND rr5.type_code = ''mortgage'') IS NULL) THEN NULL
		...
		ELSE	FALSE
	END AS vl');
INSERT INTO system.br_definition VALUES ('rrr-must-have-parties', '2014-02-20', 'infinity', 'select count(*) = 0 as vl
...
INSERT INTO system.br_definition VALUES ('rrr-shares-total-check', '2014-02-20', 'infinity', 'SELECT (SUM(nominator::DECIMAL/denominator::DECIMAL)*10000)::INT = 10000  AS vl
FROM   administrative.rrr_share 
WHERE  rrr_id = #{id}
AND    denominator != 0');
INSERT INTO system.br_definition VALUES ('ba_unit-has-caveat', '2014-02-20', 'infinity', 'WITH caveatCheck AS	(SELECT COUNT(*) AS present FROM administrative.rrr rr2 
...
SELECT (SELECT	CASE 	WHEN (SELECT caveat FROM caveatRegn) THEN TRUE
			...
			ELSE TRUE
		END) AS vl');
INSERT INTO system.br_definition VALUES ('source-attach-in-transaction-no-pendings', '2014-02-20', 'infinity', 'WITH checkServiceType	AS	(SELECT COUNT(*) AS cnt FROM application.service sv1
...
SELECT	CASE 	WHEN (SELECT (cnt = 0) FROM checkServiceType) THEN NULL
		...
		ELSE FALSE
	END AS vl');
INSERT INTO system.br_definition VALUES ('source-attach-in-transaction-allowed-type', '2014-02-20', 'infinity', 'WITH checkServiceType	AS	(SELECT COUNT(*) AS cnt FROM application.service sv1
					INNER JOIN transaction.transaction tn ON (sv1.id = tn.from_service_id)
					INNER JOIN source.source sc1 ON (tn.id = sc1.transaction_id)
				 WHERE tn.id = #{id}
				 AND sv1.request_type_code IN (''regnPowerOfAttorney'', ''regnStandardDocument'')),
...
SELECT	CASE 	WHEN (SELECT (cnt = 0) FROM checkServiceType) THEN NULL
		...
		ELSE FALSE
	END AS vl');
INSERT INTO system.br_definition VALUES ('bulk-spatial-geom-overlaps-with-loading-geom', '2014-02-20', 'infinity', 'select (select count(1)=0
...
');
INSERT INTO system.br_definition VALUES ('bulk-spatial-geom-overlaps-with-existing', '2014-02-20', 'infinity', 'select (select count(1)=0
...
where id = #{id}
  and id in (select transaction_id 
    ...
    where type_code = ''cadastre_object'')
');
INSERT INTO system.br_definition VALUES ('bulk-spatial-geom-not-valid', '2014-02-20', 'infinity', 'select (select count(1)=0
...
where id = #{id}
  and id in (select transaction_id 
    ...
    where type_code = ''cadastre_object'')
');
INSERT INTO system.br_definition VALUES ('bulk-spatial-name-unique', '2014-02-20', 'infinity', 'select (select count(1)=0
  from bulk_operation.spatial_unit_temporary 
...
where id = #{id}
  and id in (select transaction_id 
    ...
    where type_code = ''cadastre_object'')
');
INSERT INTO system.br_definition VALUES ('spatial-unit-group-not-overlap', '2014-02-20', 'infinity', 'select count(*) =0 as vl
...
INSERT INTO system.br_definition VALUES ('spatial-unit-group-inside-other-spatial-unit-group', '2014-02-20', 'infinity', 'select count(*)= 0 as vl
...
INSERT INTO system.br_definition VALUES ('spatial-unit-group-name-unique', '2014-02-20', 'infinity', 'select count(*)=0 as vl
from (
select count(*)
from cadastre.spatial_unit_group
group by name
having count(*)>1) as tmp');
INSERT INTO system.br_definition VALUES ('public-display-check-baunit-has-co', '2014-02-20', 'infinity', 'SELECT count(bu.id) = 0 as vl
   FROM  application.application_property ap, 
...
INSERT INTO system.br_definition VALUES ('public-display-check-complete-status', '2014-02-20', 'infinity', 'select
(select count(*)
from cadastre.cadastre_object co 
...
> 90 as vl
');
INSERT INTO system.br_definition VALUES ('generate-claim-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymm'') || trim(to_char(nextval(''opentenure.claim_nr_seq''), ''0000'')) AS vl');
INSERT INTO system.br_definition VALUES ('application-not-transferred', '2014-09-12', 'infinity', 'select status_code != ''transferred'' as vl from application.application where id = #{id}');
INSERT INTO system.br_definition VALUES ('application-spatial-unit-not-transferred', '2014-09-12', 'infinity', 'select count(1) = 0 as vl
...
INSERT INTO system.br_definition VALUES ('consolidation-not-again', '2014-09-12', 'infinity', 'select not records_found as vl, result from system.get_already_consolidated_records() as vl');
INSERT INTO system.br_definition VALUES ('generate-process-progress-consolidate-max', '2014-09-12', 'infinity', 'select 10 
...
INSERT INTO system.br_definition VALUES ('generate-process-progress-extract-max', '2014-09-12', 'infinity', 'select 7 + (count(*)*(3+5)) + 2 + 10 as vl from system.consolidation_config');
INSERT INTO system.br_definition VALUES ('consolidation-extraction-file-name', '2014-09-12', 'infinity', 'select ''consolidation-'' || system.get_setting(''system-id'') || to_char(clock_timestamp(), ''-yyyy-MM-dd-HH24-MI'') as vl');
INSERT INTO system.br_definition VALUES ('consolidation-db-structure-the-same', '2014-02-20', 'infinity', 'with def_of_tables as (
...
INSERT INTO system.br_definition VALUES ('cancel-relation-notification', '2015-02-25', 'infinity', 'UPDATE administrative.notifiable_party_for_baunit 
 set status = ''x''
...
select 0=0 as vl
');
INSERT INTO system.br_definition VALUES ('application-cancel-obscuration-request', '2015-03-02', 'infinity', 'UPDATE party.party
...
select 0=0 as vl
');
INSERT INTO system.br_definition VALUES ('cancel-obscuration-request', '2015-03-02', 'infinity', 'UPDATE party.party
 set classification_code = null,
     redact_code = null
...
INSERT INTO system.br_validation VALUES ('beddb4ca-99dd-11e3-86d7-b7ad3c8d30f3', 'application-on-approve-check-public-display', 'application', 'approve', NULL, NULL, NULL, NULL, 'critical', 601);
INSERT INTO system.br_validation VALUES ('bee57d18-99dd-11e3-a130-333174a347ed', 'app-check-title-ref', 'application', 'validate', NULL, NULL, NULL, NULL, 'medium', 750);
INSERT INTO system.br_validation VALUES ('bee66778-99dd-11e3-961a-834d8f1df017', 'application-br7-check-sources-have-documents', 'application', 'validate', NULL, NULL, NULL, NULL, 'warning', 570);
INSERT INTO system.br_validation VALUES ('bee86352-99dd-11e3-92f5-ff6ab473b1e3', 'app-other-app-with-caveat', 'application', 'validate', NULL, NULL, NULL, NULL, 'medium', 590);
INSERT INTO system.br_validation VALUES ('bee94db2-99dd-11e3-9503-5be69de99b6c', 'application-cancel-property-service-before-new-title', 'application', 'validate', NULL, NULL, NULL, NULL, 'critical', 390);
INSERT INTO system.br_validation VALUES ('beea381c-99dd-11e3-9c1b-b34873923d3b', 'app-title-has-primary-right', 'application', 'validate', NULL, NULL, NULL, NULL, 'critical', 100);
INSERT INTO system.br_validation VALUES ('beeafb6c-99dd-11e3-a08a-f77d218599a9', 'application-br2-check-title-documents-not-old', 'application', 'validate', NULL, NULL, NULL, NULL, 'medium', 510);
INSERT INTO system.br_validation VALUES ('beec0cdc-99dd-11e3-9a1c-57d0a8457f7a', 'applicant-name-to-owner-name-check', 'application', 'validate', NULL, NULL, NULL, NULL, 'warning', 410);
INSERT INTO system.br_validation VALUES ('beed1e56-99dd-11e3-b1d3-5b2bb3b66330', 'application-br3-check-properties-are-not-historic', 'application', 'validate', NULL, NULL, NULL, NULL, 'critical', 180);
INSERT INTO system.br_validation VALUES ('beede1a6-99dd-11e3-b037-9b875b755c8b', 'application-br4-check-sources-date-not-in-the-future', 'application', 'validate', NULL, NULL, NULL, NULL, 'warning', 710);
INSERT INTO system.br_validation VALUES ('beeecc06-99dd-11e3-8224-8f0f199b11e8', 'application-br6-check-new-title-service-is-needed', 'application', 'validate', NULL, NULL, NULL, NULL, 'warning', 730);
INSERT INTO system.br_validation VALUES ('beefb670-99dd-11e3-80be-5f1f7d0be252', 'application-on-approve-check-services-status', 'application', 'approve', NULL, NULL, NULL, NULL, 'critical', 270);
INSERT INTO system.br_validation VALUES ('bef11600-99dd-11e3-b6f4-f7e5d1966496', 'application-on-approve-check-services-without-transaction', 'application', 'approve', NULL, NULL, NULL, NULL, 'critical', 330);
INSERT INTO system.br_validation VALUES ('bef2006a-99dd-11e3-b172-971b779500e0', 'application-on-approve-check-systematic-reg-no-objection', 'application', 'approve', NULL, NULL, NULL, NULL, 'critical', 600);
INSERT INTO system.br_validation VALUES ('bef2c3ba-99dd-11e3-8a92-9fe0710c1de1', 'application-br8-check-has-services', 'application', 'validate', NULL, NULL, NULL, NULL, 'critical', 260);
INSERT INTO system.br_validation VALUES ('bef3ae1a-99dd-11e3-bf37-03b8fdd851ed', 'application-verifies-identification', 'application', 'validate', NULL, NULL, NULL, NULL, 'medium', 530);
INSERT INTO system.br_validation VALUES ('bef47174-99dd-11e3-a840-57d6651e3211', 'newtitle-br24-check-rrr-accounted', 'application', 'validate', NULL, NULL, NULL, NULL, 'critical', 160);
INSERT INTO system.br_validation VALUES ('bef534c4-99dd-11e3-9dad-2b73d16122d5', 'application-br1-check-required-sources-are-present', 'application', 'validate', NULL, NULL, NULL, NULL, 'critical', 210);
INSERT INTO system.br_validation VALUES ('bef61f24-99dd-11e3-b5c3-3f18d066d216', 'application-approve-cancel-old-titles', 'application', 'approve', NULL, NULL, NULL, NULL, 'critical', 250);
INSERT INTO system.br_validation VALUES ('bef6e27e-99dd-11e3-b5b1-2fd1b09cc082', 'application-br5-check-there-are-front-desk-services', 'application', 'validate', NULL, NULL, NULL, NULL, 'warning', 740);
INSERT INTO system.br_validation VALUES ('bef7ccde-99dd-11e3-bd39-d39c50f8cc80', 'application-for-new-title-has-cancel-property-service', 'application', 'validate', NULL, NULL, NULL, NULL, 'critical', 1);
INSERT INTO system.br_validation VALUES ('bef8b73e-99dd-11e3-a4e4-cb550d80f143', 'cancel-title-check-rrr-cancelled', 'application', 'validate', NULL, NULL, NULL, NULL, 'critical', 150);
INSERT INTO system.br_validation VALUES ('bef9537e-99dd-11e3-9ffd-b7715d85aeba', 'app-current-caveat-and-no-remove-or-vary', 'application', 'validate', NULL, NULL, NULL, NULL, 'medium', 550);
INSERT INTO system.br_validation VALUES ('bef9efc8-99dd-11e3-964f-6b27f41ee3f8', 'application-not-transferred', 'application', 'assign', NULL, NULL, NULL, NULL, 'critical', 1);
INSERT INTO system.br_validation VALUES ('befa8c08-99dd-11e3-aee6-bf668a86c63d', 'application-spatial-unit-not-transferred', 'application', 'addSpatialUnit', NULL, NULL, NULL, NULL, 'critical', 300);
INSERT INTO system.br_validation VALUES ('bf1196d2-99dd-11e3-9ac5-83797407ab3d', 'documents-present', 'service', NULL, 'complete', NULL, NULL, NULL, 'critical', 200);
INSERT INTO system.br_validation VALUES ('bf136b92-99dd-11e3-89a5-7b26db224ca3', 'application-baunit-has-parcels', 'service', NULL, 'complete', NULL, 'cadastreChange', NULL, 'critical', 130);
INSERT INTO system.br_validation VALUES ('bf142ee2-99dd-11e3-9b31-c7a94fc0681f', 'application-baunit-has-parcels', 'service', NULL, 'complete', NULL, 'redefineCadastre', NULL, 'critical', 140);
INSERT INTO system.br_validation VALUES ('bf15405c-99dd-11e3-8196-2bd23db94507', 'current-rrr-for-variation-or-cancellation-check', 'service', NULL, 'complete', NULL, NULL, NULL, 'medium', 11);
INSERT INTO system.br_validation VALUES ('bf15b58c-99dd-11e3-a690-231e73911bf4', 'current-rrr-for-variation-or-cancellation-check', 'service', NULL, 'complete', NULL, NULL, NULL, 'medium', 650);
INSERT INTO system.br_validation VALUES ('bf16ee16-99dd-11e3-945b-dfc7d9fcc1b1', 'power-of-attorney-owner-check', 'service', NULL, 'complete', NULL, NULL, NULL, 'warning', 580);
INSERT INTO system.br_validation VALUES ('bf17ff86-99dd-11e3-9bb9-e34714282e41', 'service-has-person-verification', 'service', NULL, 'complete', NULL, NULL, NULL, 'critical', 350);
INSERT INTO system.br_validation VALUES ('bf195f16-99dd-11e3-bdce-c74f42f9154c', 'application-baunit-check-area', 'service', NULL, NULL, NULL, 'cadastreChange', NULL, 'warning', 520);
INSERT INTO system.br_validation VALUES ('bf1a7090-99dd-11e3-8c09-4b0bbde3417d', 'baunit-has-multiple-mortgages', 'service', NULL, 'complete', NULL, 'mortgage', NULL, 'warning', 670);
INSERT INTO system.br_validation VALUES ('bf1b8200-99dd-11e3-bb68-f74dd327ab4c', 'document-supporting-rrr-is-current', 'service', NULL, 'complete', NULL, NULL, NULL, 'critical', 240);
INSERT INTO system.br_validation VALUES ('bf1c6c6a-99dd-11e3-b6f6-4f95f8177fc0', 'mortgage-value-check', 'service', NULL, 'complete', NULL, 'mortgage', NULL, 'warning', 700);
INSERT INTO system.br_validation VALUES ('bf1ce19a-99dd-11e3-8009-abc8261667d8', 'mortgage-value-check', 'service', NULL, 'complete', NULL, 'varyMortgage', NULL, 'warning', 690);
INSERT INTO system.br_validation VALUES ('bf1dcbfa-99dd-11e3-b541-7b279723c27b', 'power-of-attorney-service-has-document', 'service', NULL, 'complete', NULL, 'regnPowerOfAttorney', NULL, 'critical', 340);
INSERT INTO system.br_validation VALUES ('bf1eb65a-99dd-11e3-a82a-63bcc9eb89eb', 'required-sources-are-present', 'service', NULL, 'complete', NULL, NULL, NULL, 'critical', 230);
INSERT INTO system.br_validation VALUES ('bf1fa0c4-99dd-11e3-80e7-6ba652a5d098', 'service-on-complete-without-transaction', 'service', NULL, 'complete', NULL, NULL, NULL, 'critical', 360);
INSERT INTO system.br_validation VALUES ('bf208b24-99dd-11e3-b094-4bfda581097c', 'service-title-terminated', 'service', NULL, 'complete', NULL, NULL, NULL, 'critical', 190);
INSERT INTO system.br_validation VALUES ('bf217584-99dd-11e3-971f-cb1338a539aa', 'service-check-no-previous-digital-title-service', 'service', NULL, 'complete', NULL, 'newDigitalTitle', NULL, 'warning', 720);
INSERT INTO system.br_validation VALUES ('bf2ee336-99dd-11e3-b589-9fa52f2707db', 'target-ba_unit-check-if-pending', 'ba_unit', NULL, NULL, 'current', NULL, NULL, 'critical', 280);
INSERT INTO system.br_validation VALUES ('bf312d30-99dd-11e3-9a36-2b027935a066', 'ba_unit-has-cadastre-object', 'ba_unit', NULL, NULL, 'current', NULL, NULL, 'medium', 500);
INSERT INTO system.br_validation VALUES ('bf32b3da-99dd-11e3-a86b-fb97c1bc1883', 'ba_unit-has-compatible-cadastre-object', 'ba_unit', NULL, NULL, 'current', NULL, NULL, 'medium', 540);
INSERT INTO system.br_validation VALUES ('bf3488a4-99dd-11e3-85e6-3f35aa386078', 'ba_unit-spatial_unit-area-comparison', 'ba_unit', NULL, NULL, 'current', NULL, NULL, 'medium', 490);
INSERT INTO system.br_validation VALUES ('bf37e40e-99dd-11e3-bf28-2f86e5fe7685', 'ba_unit-has-a-valid-primary-right', 'ba_unit', NULL, NULL, 'current', NULL, NULL, 'critical', 20);
INSERT INTO system.br_validation VALUES ('bf3a2e08-99dd-11e3-be9e-cfcb4db81fe7', 'newtitle-br22-check-different-owners', 'ba_unit', NULL, NULL, 'current', NULL, NULL, 'warning', 680);
INSERT INTO system.br_validation VALUES ('bf4ccbee-99dd-11e3-8765-b7ba0436cb1b', 'cadastre-redefinition-target-geometries-dont-overlap', 'cadastre_object', NULL, NULL, 'current', 'redefineCadastre', NULL, 'critical', 120);
INSERT INTO system.br_validation VALUES ('bf4e046e-99dd-11e3-ac01-67826511e731', 'cadastre-redefinition-target-geometries-dont-overlap', 'cadastre_object', NULL, NULL, 'pending', 'redefineCadastre', NULL, 'warning', 430);
INSERT INTO system.br_validation VALUES ('bf4fb228-99dd-11e3-8f06-ff089b1b7fe4', 'area-check-percentage-newareas-oldareas', 'cadastre_object', NULL, NULL, 'pending', 'cadastreChange', NULL, 'warning', 640);
INSERT INTO system.br_validation VALUES ('bf502758-99dd-11e3-aa31-b3de9eb0f474', 'area-check-percentage-newareas-oldareas', 'cadastre_object', NULL, NULL, 'current', 'cadastreChange', NULL, 'warning', 630);
INSERT INTO system.br_validation VALUES ('bf5111b8-99dd-11e3-910a-073fdcc41e3f', 'area-check-percentage-newofficialarea-calculatednewarea', 'cadastre_object', NULL, NULL, 'current', 'cadastreChange', NULL, 'warning', 610);
INSERT INTO system.br_validation VALUES ('bf5186e8-99dd-11e3-87fe-7f5d1ec0ee3d', 'area-check-percentage-newofficialarea-calculatednewarea', 'cadastre_object', NULL, NULL, 'pending', 'cadastreChange', NULL, 'warning', 620);
INSERT INTO system.br_validation VALUES ('bf529862-99dd-11e3-b8b9-7725d84e4c37', 'cadastre-object-check-name', 'cadastre_object', NULL, NULL, 'current', 'cadastreChange', NULL, 'medium', 600);
INSERT INTO system.br_validation VALUES ('bf530d92-99dd-11e3-8ac9-5fe3ebe62fec', 'cadastre-object-check-name', 'cadastre_object', NULL, NULL, 'pending', 'cadastreChange', NULL, 'medium', 660);
INSERT INTO system.br_validation VALUES ('bf5ecd8a-99dd-11e3-897f-83b0d2f7ca79', 'cadastre-redefinition-union-old-new-the-same', 'cadastre_object', NULL, NULL, 'current', 'redefineCadastre', NULL, 'warning', 400);
INSERT INTO system.br_validation VALUES ('bf5f42c4-99dd-11e3-adf1-c35e9d107011', 'cadastre-redefinition-union-old-new-the-same', 'cadastre_object', NULL, NULL, 'pending', 'redefineCadastre', NULL, 'warning', 420);
INSERT INTO system.br_validation VALUES ('bf605434-99dd-11e3-94b0-db8d0a31a5eb', 'new-cadastre-objects-do-not-overlap', 'cadastre_object', NULL, NULL, 'pending', 'cadastreChange', NULL, 'warning', 60);
INSERT INTO system.br_validation VALUES ('bf60f074-99dd-11e3-b103-3f68ada0b2ea', 'new-cadastre-objects-do-not-overlap', 'cadastre_object', NULL, NULL, 'current', 'cadastreChange', NULL, 'medium', 480);
INSERT INTO system.br_validation VALUES ('bf6228fe-99dd-11e3-8222-fb2038631753', 'new-cadastre-objects-present', 'cadastre_object', NULL, NULL, 'pending', 'cadastreChange', NULL, 'warning', 370);
INSERT INTO system.br_validation VALUES ('bf629e2e-99dd-11e3-9f6d-1bce9d19f1b0', 'new-cadastre-objects-present', 'cadastre_object', NULL, NULL, 'current', 'cadastreChange', NULL, 'critical', 50);
INSERT INTO system.br_validation VALUES ('bf6424ce-99dd-11e3-871d-e34e420bd308', 'target-and-new-union-the-same', 'cadastre_object', NULL, NULL, 'pending', 'cadastreChange', NULL, 'warning', 470);
INSERT INTO system.br_validation VALUES ('bf649a08-99dd-11e3-9400-bf6d3595104e', 'target-and-new-union-the-same', 'cadastre_object', NULL, NULL, 'current', 'cadastreChange', NULL, 'warning', 460);
INSERT INTO system.br_validation VALUES ('bf65ab78-99dd-11e3-8578-97b6e4e3f10c', 'target-parcels-check-isapolygon', 'cadastre_object', NULL, NULL, 'pending', 'cadastreChange', NULL, 'critical', 90);
INSERT INTO system.br_validation VALUES ('bf6647b8-99dd-11e3-8e01-d33af44aed65', 'target-parcels-check-isapolygon', 'cadastre_object', NULL, NULL, 'current', 'cadastreChange', NULL, 'critical', 80);
INSERT INTO system.br_validation VALUES ('bf678042-99dd-11e3-91fc-23b055a0f1db', 'target-parcels-check-nopending', 'cadastre_object', NULL, NULL, 'pending', NULL, NULL, 'critical', 310);
INSERT INTO system.br_validation VALUES ('bf67f572-99dd-11e3-a9e8-6739cfc2b3de', 'target-parcels-check-nopending', 'cadastre_object', NULL, NULL, 'current', NULL, NULL, 'critical', 300);
INSERT INTO system.br_validation VALUES ('bf692df2-99dd-11e3-88af-bf24a927350a', 'target-parcels-present', 'cadastre_object', NULL, NULL, 'pending', NULL, NULL, 'warning', 450);
INSERT INTO system.br_validation VALUES ('bf6a3f6c-99dd-11e3-9a09-8f3026fcfa46', 'target-parcels-present', 'cadastre_object', NULL, NULL, 'current', NULL, NULL, 'warning', 440);
INSERT INTO system.br_validation VALUES ('bf6b50dc-99dd-11e3-8310-af68f5931839', 'survey-points-present', 'cadastre_object', NULL, NULL, 'pending', 'cadastreChange', NULL, 'warning', 380);
INSERT INTO system.br_validation VALUES ('bf6bc60c-99dd-11e3-bc9d-574417653a44', 'survey-points-present', 'cadastre_object', NULL, NULL, 'current', 'cadastreChange', NULL, 'critical', 70);
INSERT INTO system.br_validation VALUES ('bf851ad0-99dd-11e3-a532-1b4026ab96d7', 'ba_unit-has-several-mortgages-with-same-rank', 'rrr', NULL, NULL, 'current', NULL, NULL, 'critical', 170);
INSERT INTO system.br_validation VALUES ('bf86a170-99dd-11e3-a2a8-bf0f7b339519', 'rrr-must-have-parties', 'rrr', NULL, NULL, 'current', NULL, NULL, 'critical', 110);
INSERT INTO system.br_validation VALUES ('bf8764ca-99dd-11e3-8284-736cc8ee135c', 'rrr-has-pending', 'rrr', NULL, NULL, 'current', NULL, NULL, 'critical', 290);
INSERT INTO system.br_validation VALUES ('bf88010a-99dd-11e3-acc8-9783e3e19a06', 'rrr-shares-total-check', 'rrr', NULL, NULL, 'current', NULL, NULL, 'critical', 40);
INSERT INTO system.br_validation VALUES ('bf88c45a-99dd-11e3-8051-13d27ae9940b', 'ba_unit-has-caveat', 'rrr', NULL, NULL, 'current', NULL, NULL, 'critical', 30);
INSERT INTO system.br_validation VALUES ('bf991846-99dd-11e3-b4fb-4b444862ac47', 'source-attach-in-transaction-no-pendings', 'source', NULL, NULL, 'pending', NULL, NULL, 'critical', 220);
INSERT INTO system.br_validation VALUES ('bf9ac600-99dd-11e3-ae93-b3424d58aab7', 'source-attach-in-transaction-allowed-type', 'source', NULL, NULL, 'pending', NULL, NULL, 'critical', 560);
INSERT INTO system.br_validation VALUES ('bfad3cd6-99dd-11e3-ad94-575ceec4b27e', 'bulk-spatial-geom-overlaps-with-loading-geom', 'bulkOperationSpatial', NULL, NULL, 'pending', NULL, NULL, 'warning', 440);
INSERT INTO system.br_validation VALUES ('bfafade0-99dd-11e3-8c7f-9f27f35049a0', 'bulk-spatial-geom-overlaps-with-existing', 'bulkOperationSpatial', NULL, NULL, 'pending', NULL, NULL, 'warning', 440);
INSERT INTO system.br_validation VALUES ('bfb09840-99dd-11e3-b41f-5b4e49782eaf', 'bulk-spatial-geom-not-valid', 'bulkOperationSpatial', NULL, NULL, 'pending', NULL, NULL, 'warning', 440);
INSERT INTO system.br_validation VALUES ('bfb182a0-99dd-11e3-bffe-dfa75b679d35', 'bulk-spatial-name-unique', 'bulkOperationSpatial', NULL, NULL, 'pending', NULL, NULL, 'warning', 440);
INSERT INTO system.br_validation VALUES ('bfbf658c-99dd-11e3-9ae3-0bfef3d70817', 'spatial-unit-group-not-overlap', 'spatial_unit_group', NULL, NULL, NULL, NULL, NULL, 'critical', 2);
INSERT INTO system.br_validation VALUES ('bfc1d696-99dd-11e3-9f78-37e12aca6a61', 'spatial-unit-group-name-unique', 'spatial_unit_group', NULL, NULL, NULL, NULL, NULL, 'critical', 1);
INSERT INTO system.br_validation VALUES ('bfcfe088-99dd-11e3-98dc-f329301d6629', 'public-display-check-baunit-has-co', 'public_display', NULL, NULL, NULL, NULL, NULL, 'warning', 2);
INSERT INTO system.br_validation VALUES ('bfd11908-99dd-11e3-8302-931a1e68e8f6', 'public-display-check-complete-status', 'public_display', NULL, NULL, NULL, NULL, NULL, 'warning', 1);
INSERT INTO system.br_validation VALUES ('bfeae2fc-99dd-11e3-98d3-47256ea2b59e', 'consolidation-db-structure-the-same', 'consolidation', NULL, NULL, NULL, NULL, NULL, 'critical', 570);
INSERT INTO system.br_validation VALUES ('consolidation-not-again', 'consolidation-not-again', 'consolidation', NULL, NULL, NULL, NULL, NULL, 'critical', 1);
INSERT INTO system.br_validation VALUES ('bfc0ec2c-99dd-11e3-bc3f-13923fd8d236', 'spatial-unit-group-inside-other-spatial-unit-group', 'spatial_unit_group', NULL, NULL, NULL, NULL, NULL, 'medium', 2);
INSERT INTO system.br_validation VALUES ('cancel-relation-notification', 'cancel-relation-notification', 'application', 'approve', NULL, NULL, NULL, NULL, 'warning', 300);
